...
from pregnancy_openai_service import PregnancyOpenAIService
...
class PregnancyService:
    def __init__(self):
        ...
        try:
            ...
            print("✅ Pregnancy OpenAI service initialized")
        except ValueError as e:
            print(f"⚠️ Pregnancy OpenAI service not available: {e}")
