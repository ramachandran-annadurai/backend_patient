...
class DoctorProfileCompletionScreen extends StatefulWidget {
  ...
  @override
  State<DoctorProfileCompletionScreen> createState() =>
...
class _DoctorProfileCompletionScreenState
  ...
  Future<void> _completeProfile() async {
    ...
    final success = await authFactory.doctor.completeDoctorProfile(
    ...
    if (success && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(authFactory.error ?? 'Profile completion failed'),
                ...
                Consumer<AuthProviderFactory>(
                  builder: (context, authFactory, child) {
                    return LoadingButton(
                      onPressed:
                          authFactory.isLoading ? null : _completeProfile,
                      isLoading: authFactory.isLoading,
