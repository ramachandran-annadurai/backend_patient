...
class OCRResponse(BaseModel):
    ...
    results: Optional[List[OCRResult]] = Field(None, description="List of extracted text results")
    ...
    # Storage fields
    document_id: Optional[str] = Field(None, description="Document ID in storage")
    patient_id: Optional[str] = Field(None, description="Patient ID for medical history")
    storage_type: Optional[str] = Field(None, description="Storage type (MongoDB or Mock Storage)")
    processing_type: Optional[str] = Field(None, description="Processing type (ocr_extraction or base64_storage)")
    is_image: Optional[bool] = Field(None, description="Whether the file is an image")
