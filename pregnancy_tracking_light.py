#!/usr/bin/env python3
"""
Lightweight Pregnancy Tracking Service (No OpenAI Dependency)
This version provides fallback responses without requiring OpenAI API.
"""
...
def health_check():
    ...
    return jsonify({
        "status": "healthy",
        "service": "Pregnancy Tracking Service (Lightweight)",
        ...
        "note": "This is the lightweight version without OpenAI dependency"
    }), 200
...
def openai_status():
    ...
    try:
        ...
        return jsonify({
            ...
            "status": "Using fallback responses (lightweight mode)",
...
if __name__ == '__main__':
    print("🤰 Starting Pregnancy Tracking Service (Lightweight)...")
    print("=" * 60)
    ...
    print("=" * 60)
    print("Note: This is the lightweight version with fallback responses")
    print("=" * 60)
